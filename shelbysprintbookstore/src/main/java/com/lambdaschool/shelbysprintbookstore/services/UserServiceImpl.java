...
import com.lambdaschool.shelbysprintbookstore.exceptions.ResourceNotFoundException;
import com.lambdaschool.shelbysprintbookstore.models.Quote;
import com.lambdaschool.shelbysprintbookstore.models.User;
import com.lambdaschool.shelbysprintbookstore.models.UserRoles;
import com.lambdaschool.shelbysprintbookstore.repository.RoleRepository;
import com.lambdaschool.shelbysprintbookstore.repository.UserRepository;
    ...
    public User update(User user, long id)
    {
        ...
        if (currentUser != null)
        {
            if (id == currentUser.getUserid())
            {
                ...
                {
                    // to keep myself from getting confused, I decided to go
